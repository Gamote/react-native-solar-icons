...
const SvgGameboy = (props: SvgProps) => (
  ...
  >
    ...
    <G fill="#000" opacity={0.5}>
      <Path d="M16.333 13.833a.833.833 0 1 1-1.666 0 .833.833 0 0 1 1.666 0M16.333 17.167a.833.833 0 1 1-1.666 0 .833.833 0 0 1 1.666 0M14.667 15.5a.833.833 0 1 1-1.667 0 .833.833 0 0 1 1.667 0M18 15.5a.833.833 0 1 1-1.667 0 .833.833 0 0 1 1.667 0" />
    </G>
  </Svg>
);
