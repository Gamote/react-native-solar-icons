...
const SvgMonitorCamera = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="M22 10v1c0 2.828 0 4.243-.879 5.121C20.243 17 18.828 17 16 17H8c-2.828 0-4.243 0-5.121-.879C2 15.243 2 13.828 2 11V9.5c0-3.287 0-4.931.908-6.038a4 4 0 0 1 .554-.554C4.57 2 6.212 2 9.5 2"
    />
  </Svg>
);
