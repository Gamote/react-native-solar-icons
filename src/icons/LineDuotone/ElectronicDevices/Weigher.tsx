...
const SvgWeigher = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="M8 18h8M16.412 9.971l.665-1.664a2 2 0 0 0-1.528-2.715l-.425-.071a19 19 0 0 0-6.248 0l-.425.07a2 2 0 0 0-1.528 2.716l.665 1.664c.236.59.871.914 1.487.76 1.92-.48 3.93-.48 5.85 0a1.27 1.27 0 0 0 1.486-.76ZM10.18 9.93l-.675-1.884"
    />
  </Svg>
);
