...
const SvgIPhone = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="M15 19H9M16.748 2.377l-.084.127c-.756 1.134-1.134 1.7-1.686 2.044a3 3 0 0 1-.342.183C14.045 5 13.363 5 12 5s-2.044 0-2.636-.27a3 3 0 0 1-.342-.182c-.552-.343-.93-.91-1.686-2.044l-.084-.127"
      opacity={0.5}
    />
  </Svg>
);
