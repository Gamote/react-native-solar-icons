...
const SvgPrinterMinimalistic = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="M18 12v4c0 2.828 0 4.243-.879 5.121C16.243 22 14.828 22 12 22s-4.243 0-5.121-.879C6 20.243 6 18.828 6 16v-4"
    />
    <Path
      stroke="#000"
      strokeWidth={1.5}
    ...
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="M19.5 12.443C17.873 11.713 15.412 11 12 11s-5.873.712-7.5 1.443"
    />
  </Svg>
);
