...
const SvgGalleryWide = (props: SvgProps) => (
  ...
  >
    <Path
      stroke="#000"
      strokeWidth={1.5}
      d="M2 13.438C2 9.666 2 7.78 3.172 6.609S6.229 5.438 10 5.438h4c3.771 0 5.657 0 6.828 1.171S22 9.666 22 13.438c0 3.77 0 5.656-1.172 6.828S17.771 21.438 14 21.438h-4c-3.771 0-5.657 0-6.828-1.172S2 17.209 2 13.438Z"
    />
    <Path
      stroke="#000"
      strokeWidth={1.5}
