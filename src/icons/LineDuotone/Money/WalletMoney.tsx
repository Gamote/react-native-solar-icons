...
const SvgWalletMoney = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      stroke="#000"
      strokeWidth={1.5}
      d="M20.965 10c-.078-1.872-.328-3.02-1.137-3.828C18.657 5 16.771 5 13 5h-3C6.229 5 4.343 5 3.172 6.172S2 9.229 2 13s0 5.657 1.172 6.828S6.229 21 10 21h3c3.771 0 5.657 0 6.828-1.172.809-.808 1.06-1.956 1.137-3.828"
    />
    <Path
      stroke="#000"
      strokeLinecap="round"
      strokeWidth={1.5}
      d="m6 5 3.735-2.477a3.24 3.24 0 0 1 3.53 0L17 5"
      opacity={0.5}
    />
    <Path
      stroke="#000"
