...
const SvgJarOfPills = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    ...
    />
    <Path
      d="M5.50122 7.79902L7.90434 5.87652C8.44688 5.4425 8.71814 5.22549 9.03955 5.11274C9.36095 5 9.70834 5 10.4031 5H13.6427C14.3438 5 14.6943 5 15.0182 5.11466C15.3421 5.22933 15.6146 5.44989 16.1595 5.89102L18.5168 7.79931C19.455 8.55877 20 9.70126 20 10.9083V17.5649C20 18.4927 19.6775 19.3916 19.0877 20.1078L18.7294 20.5428C17.9696 21.4655 16.837 22 15.6417 22H8.95693C8.38582 22 8.10026 22 7.82957 21.9628C7.02661 21.8526 6.27608 21.5011 5.67738 20.9548C5.47554 20.7706 5.29272 20.5513 4.92711 20.1125C4.32806 19.3937 4 18.4875 4 17.5518V10.9225C4 9.70736 4.55236 8.55811 5.50122 7.79902Z"
      stroke={props.primaryColor}
      strokeWidth={1.5}
      strokeLinecap="round"
    />
    <Path
      d="M12 12V16M10 14L14 14"
      stroke={props.primaryColor}
      strokeWidth={1.5}
      strokeLinecap="round"
    />
