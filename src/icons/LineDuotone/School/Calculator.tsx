...
const SvgCalculator = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    ...
    <Path
      ...
      strokeWidth={1.5}
    />
    <Circle opacity={0.5} cx={8} cy={13} r={1} fill="black" />
    <Circle opacity={0.5} cx={8} cy={17} r={1} fill="black" />
    <Circle opacity={0.5} cx={12} cy={13} r={1} fill="black" />
    <Circle opacity={0.5} cx={12} cy={17} r={1} fill="black" />
    <Circle opacity={0.5} cx={16} cy={13} r={1} fill="black" />
    <Circle opacity={0.5} cx={16} cy={17} r={1} fill="black" />
  </Svg>
);
