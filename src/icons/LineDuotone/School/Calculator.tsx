...
const SvgCalculator = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      ...
      opacity={0.5}
    />
    <Circle cx={8} cy={13} r={1} fill="#000" opacity={0.5} />
    <Circle cx={8} cy={17} r={1} fill="#000" opacity={0.5} />
    <Circle cx={12} cy={13} r={1} fill="#000" opacity={0.5} />
    <Circle cx={12} cy={17} r={1} fill="#000" opacity={0.5} />
    <Circle cx={16} cy={13} r={1} fill="#000" opacity={0.5} />
    <Circle cx={16} cy={17} r={1} fill="#000" opacity={0.5} />
  </Svg>
);
