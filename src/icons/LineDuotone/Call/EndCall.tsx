...
const SvgEndCall = (props: SvgProps) => (
  ...
  >
    <Path
      stroke="#000"
      strokeWidth={1.5}
      d="M8 12.862v.616c0 .853-.577 1.604-1.42 1.852l-2 .586C3.296 16.292 2 15.363 2 14.065v-1.923c0-.49.125-.971.44-1.353m18.93-.933c.446.398.63.975.63 1.562v2.125c0 1.184-1.09 2.09-2.3 1.913l-2-.293c-.977-.144-1.7-.957-1.7-1.913v-.388"
    />
    <Path
      fill="#000"
