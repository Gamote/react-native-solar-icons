...
const SvgPasswordMinimalisticInput = (props: SvgProps) => (
  ...
  >
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="M3.172 18.828C4.343 20 6.229 20 10 20h5c3.114-.01 4.765-.108 5.828-1.172C22 17.657 22 15.771 22 12s0-5.657-1.172-6.828C19.765 4.108 18.114 4.01 15 4L12 4h-2C6.229 4 4.343 4 3.172 5.172S2 8.229 2 12s0 5.657 1.172 6.828Z"
      opacity={0.5}
    />
    <Path
      fill="#000"
