...
const SvgFaceScanCircle = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      fillRule="evenodd"
      d="M12 19.583a7.583 7.583 0 1 0 0-15.166 7.583 7.583 0 0 0 0 15.166m-3.06-5.044a.71.71 0 0 1 .995-.148c.59.437 1.3.69 2.065.69a3.45 3.45 0 0 0 2.065-.69.71.71 0 1 1 .846 1.142 4.87 4.87 0 0 1-2.911.97c-1.086 0-2.09-.361-2.911-.97a.71.71 0 0 1-.148-.994m6.377-4.139c0 .688-.37 1.245-.829 1.245s-.83-.557-.83-1.245c0-.687.372-1.244.83-1.244s.83.557.83 1.244m-5.805 1.245c.458 0 .83-.557.83-1.245 0-.687-.372-1.244-.83-1.244s-.83.557-.83 1.244c0 .688.372 1.245.83 1.245"
      clipRule="evenodd"
    />
  </Svg>
);
