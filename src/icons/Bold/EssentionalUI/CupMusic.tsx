...
const SvgCupMusic = (props: SvgProps) => (
  <Svg
    ...
    {...props}
  >
    <Path fill="#000" d="M11.316 11.267a1 1 0 1 0 0-2 1 1 0 0 0 0 2" />
    <Path
      fill="#000"
      fillRule="evenodd"
    ...
    <Path
      fill="#000"
      d="M2 8.162v.073c0 .86 0 1.291.207 1.643s.584.561 1.336.98l.794.44c-.547-1.848-.73-3.834-.797-5.532l-.01-.221-.001-.052c-.652.226-1.018.395-1.246.711C2 6.597 2 7.12 2 8.162M22 8.162v.073c0 .86 0 1.291-.207 1.643s-.584.561-1.336.98l-.793.44c.546-1.848.729-3.834.796-5.532l.01-.221.002-.052c.651.226 1.017.395 1.245.711.283.393.283.915.283 1.958"
    />
  </Svg>
);
