...
const SvgXxx = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M9.124 9.416 7.401 12l1.723 2.584a.75.75 0 0 1 .126.405.75.75 0 0 1 .126-.405L11.099 12 9.376 9.416a.75.75 0 0 1-.126-.404.75.75 0 0 1-.126.404M14.624 9.416 12.901 12l1.723 2.584a.75.75 0 0 1 .126.405.75.75 0 0 1 .126-.405L16.599 12l-1.723-2.584a.75.75 0 0 1-.126-.405.75.75 0 0 1-.126.405"
    />
  </Svg>
);
