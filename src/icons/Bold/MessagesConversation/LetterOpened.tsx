...
const SvgLetterOpened = (props: SvgProps) => (
  ...
  >
    <Path
      fill="#000"
      d="M10 22h4c3.771 0 5.657 0 6.828-1.171S22 17.77 22 14s0-5.657-1.172-6.828c-.362-.363-.794-.613-1.328-.786v2.773c.003.34.009.911-.236 1.433-.244.522-.686.884-.95 1.1q-.04.03-.073.06l-1.507 1.255c-.86.718-1.61 1.342-2.284 1.776-.725.466-1.51.812-2.45.812s-1.724-.346-2.45-.812c-.674-.434-1.423-1.058-2.284-1.775l-1.507-1.256-.073-.06c-.264-.216-.705-.578-.95-1.1-.244-.522-.24-1.093-.237-1.433l.001-.096V6.385c-.534.173-.966.424-1.328.787C2 8.343 2 10.229 2 14s0 5.657 1.172 6.829S6.229 22 10 22"
    />
    <Path
      fill="#000"
      fillRule="evenodd"
