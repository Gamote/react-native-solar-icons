...
const SvgStationMinimalistic = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M12 5.572c-1.9 0-3.45 1.554-3.45 3.483 0 .946.372 1.801.978 2.429a.75.75 0 0 1-1.08 1.041 4.99 4.99 0 0 1-1.398-3.47c0-2.747 2.21-4.983 4.95-4.983s4.95 2.236 4.95 4.983a4.99 4.99 0 0 1-1.361 3.432.75.75 0 1 1-1.091-1.03c.59-.625.952-1.47.952-2.402 0-1.93-1.55-3.483-3.45-3.483"
    />
    <Path
      fill="#000"
      fillRule="evenodd"
