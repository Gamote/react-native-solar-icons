...
const SvgTextBoldSquare = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    <Path
      d="M14.25 9C14.25 10.2426 13.2426 11.25 12 11.25H8.75V7.52174C8.75 7.09552 9.09552 6.75 9.52174 6.75H12C13.2426 6.75 14.25 7.75736 14.25 9Z"
      fill={props.primaryColor}
    />
    <Path
      d="M8.75 16.8235V12.75H13C14.2426 12.75 15.25 13.7574 15.25 15C15.25 16.2426 14.2426 17.25 13 17.25H9.17647C8.94094 17.25 8.75 17.0591 8.75 16.8235Z"
      fill={props.primaryColor}
    />
    <Path
      fillRule="evenodd"
