...
const SvgTextBoldSquare = (props: SvgProps) => (
  ...
  >
    <Path
      fill="#000"
      d="M14.25 9A2.25 2.25 0 0 1 12 11.25H8.75V7.522c0-.426.346-.772.772-.772H12A2.25 2.25 0 0 1 14.25 9M8.75 16.824V12.75H13a2.25 2.25 0 0 1 0 4.5H9.176a.426.426 0 0 1-.426-.427"
    />
    <Path
      fill="#000"
      fillRule="evenodd"
