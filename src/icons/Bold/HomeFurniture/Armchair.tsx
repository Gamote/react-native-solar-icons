...
const SvgArmchair = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M6 8.672v-.518c0-2.3 0-3.451.482-4.308A3.65 3.65 0 0 1 7.8 2.495C8.635 2 9.757 2 12 2s3.365 0 4.2.495c.547.324 1.002.79 1.318 1.351C18 4.703 18 5.853 18 8.154v.518a3.32 3.32 0 0 0-1.21 2.574v3.087c0 .472 0 .707-.147.854-.146.146-.382.146-.854.146H8.212c-.472 0-.708 0-.854-.146-.146-.147-.146-.382-.146-.854v-3.087A3.32 3.32 0 0 0 6 8.672"
    />
  </Svg>
);
