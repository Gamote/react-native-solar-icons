...
const SvgSuitcaseLines = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M2 14c0-.839 0-1.585.013-2.25h19.974C22 12.415 22 13.161 22 14s0 1.585-.013 2.25H2.013C2 15.585 2 14.839 2 14M2.08 17.75c.115 1.44.397 2.384 1.092 3.078C4.343 22 6.229 22 10 22h4c3.771 0 5.657 0 6.828-1.172.695-.694.977-1.639 1.093-3.078z"
    />
  </Svg>
);
