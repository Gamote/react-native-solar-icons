...
const SvgDiskette = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M16.183 18.905c.065.483.067 1.131.067 2.095v.931C15.094 22 13.7 22 12 22s-3.094 0-4.25-.069V21c0-.964.002-1.612.067-2.095.062-.461.169-.659.3-.789s.327-.237.788-.3c.483-.064 1.131-.066 2.095-.066h2c.964 0 1.612.002 2.095.067.461.062.659.169.789.3s.237.327.3.788"
    />
  </Svg>
);
