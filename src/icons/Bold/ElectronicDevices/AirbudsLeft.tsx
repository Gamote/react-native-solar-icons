...
const SvgAirbudsLeft = (props: SvgProps) => (
  ...
  >
    <Path
      fill="#000"
      fillRule="evenodd"
      d="M13.265 4.95a.75.75 0 0 0 .586.885 4.26 4.26 0 0 1 3.314 3.314.75.75 0 1 0 1.47-.298 5.76 5.76 0 0 0-4.486-4.486.75.75 0 0 0-.884.586"
      clipRule="evenodd"
    />
    <Path
      fill="#000"
