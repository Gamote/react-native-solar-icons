...
const SvgRadioMinimalistic = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      fillRule="evenodd"
      d="M8 11.75a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5M4.25 14a3.75 3.75 0 1 1 7.5 0 3.75 3.75 0 0 1-7.5 0M12.75 11a.75.75 0 0 1 .75-.75H19a.75.75 0 0 1 0 1.5h-5.5a.75.75 0 0 1-.75-.75M12.75 14a.75.75 0 0 1 .75-.75H19a.75.75 0 0 1 0 1.5h-5.5a.75.75 0 0 1-.75-.75M12.75 17a.75.75 0 0 1 .75-.75H19a.75.75 0 0 1 0 1.5h-5.5a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
    <Path
      fill="#000"
      d="M15.38 2.647a.75.75 0 0 0-.76-1.293l-7.99 4.7C7.475 6.003 8.477 6 9.68 6z"
    />
  </Svg>
);
