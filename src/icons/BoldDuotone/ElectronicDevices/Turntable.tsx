...
const SvgTurntable = (props: SvgProps) => (
  ...
  >
    <Path
      fill="#000"
      d="M3.172 3.464C2 4.93 2 7.286 2 12s0 7.071 1.172 8.535S6.229 22 10 22h4c3.771 0 5.657 0 6.828-1.465C22 19.072 22 16.714 22 12s0-7.071-1.172-8.536S17.771 2 14 2h-4C6.229 2 4.343 2 3.172 3.464"
      opacity={0.5}
    />
    <Path
      fill="#000"
