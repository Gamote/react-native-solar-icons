...
const SvgProjector = (props: SvgProps) => (
  <Svg
    ...
    {...props}
  >
    <Path fill="#000" d="M6.25 9.5a.75.75 0 1 0-1.5 0V11a.75.75 0 1 0 1.5 0z" />
    <Path
      fill="#000"
      fillRule="evenodd"
      d="M19 9A5 5 0 1 1 9 9a5 5 0 0 1 10 0m-5.75-2a.75.75 0 0 1 .75-.75A2.75 2.75 0 1 1 11.25 9a.75.75 0 0 1 1.5 0A1.25 1.25 0 1 0 14 7.75a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
    <Path
      fill="#000"
