...
const SvgAirbudsLeft = (props: SvgProps) => (
  ...
  >
    <Path
      fill="#000"
      d="M4.382 22C3.067 22 2 20.88 2 19.5h4.765c0 1.38-1.067 2.5-2.383 2.5"
    />
    <Path
      fill="#000"
      fillRule="evenodd"
    ...
    <Path
      fill="#000"
      d="M15.25 13a.75.75 0 0 1 .75.75V18h2.25a.75.75 0 0 1 0 1.5h-3a.75.75 0 0 1-.75-.75v-5a.75.75 0 0 1 .75-.75"
    />
    <Path
      fill="#000"
      fillRule="evenodd"
      d="M13.265 4.95a.75.75 0 0 0 .586.885 4.26 4.26 0 0 1 3.314 3.314.75.75 0 0 0 1.47-.298 5.76 5.76 0 0 0-4.486-4.486.75.75 0 0 0-.884.586"
      clipRule="evenodd"
      opacity={0.5}
    />
  </Svg>
