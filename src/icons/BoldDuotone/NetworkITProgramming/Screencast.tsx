...
const SvgScreencast = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M2.75 9.5a.75.75 0 0 0 0 1.5A8.25 8.25 0 0 1 11 19.25a.75.75 0 0 0 1.5 0c0-5.385-4.365-9.75-9.75-9.75"
    />
    <Path
      fill="#000"
    ...
    <Path
      fill="#000"
      d="M2.75 15.5a.75.75 0 0 0 0 1.5A2.25 2.25 0 0 1 5 19.25a.75.75 0 0 0 1.5 0 3.75 3.75 0 0 0-3.75-3.75"
    />
  </Svg>
);
