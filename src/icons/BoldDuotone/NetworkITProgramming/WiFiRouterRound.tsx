...
const SvgWiFiRouterRound = (props: SvgProps) => (
  <Svg
    ...
    {...props}
  >
    <Path fill="#000" d="M7 14a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5" />
    <Path
      fill="#000"
      fillRule="evenodd"
    ...
    <Path
      fill="#000"
      d="m5.469 19.511-1.112 1.853a.75.75 0 0 0 1.286.772l1.432-2.386H7a5 5 0 0 1-1.531-.239M16.925 19.75l1.432 2.386a.75.75 0 0 0 1.286-.772l-1.112-1.853a5 5 0 0 1-1.531.24z"
      opacity={0.5}
    />
    <Path
      fill="#000"
    ...
    <Path
      ...
      opacity={0.7}
    />
    <Path fill="#000" d="M17.5 7.75a1 1 0 1 1-2 0 1 1 0 0 1 2 0" />
  </Svg>
);
