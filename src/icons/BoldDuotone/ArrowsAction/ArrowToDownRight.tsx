...
const SvgArrowToDownRight = (props: SvgProps) => (
  ...
  >
    ...
    <G fill="#000" opacity={0.5}>
      <Path d="M11.25 9.5c0-.953.28-2.367 1.141-3.563.89-1.235 2.365-2.187 4.609-2.187a.75.75 0 0 1 0 1.5c-1.756 0-2.78.715-3.391 1.563-.639.887-.859 1.974-.859 2.687v8.19l-.75.75-.75-.75zM11.802 20.224" />
    </G>
  </Svg>
);
