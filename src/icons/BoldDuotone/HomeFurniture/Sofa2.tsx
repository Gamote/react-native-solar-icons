...
const SvgSofa2 = (props: SvgProps) => (
  ...
  >
    ...
    <G fill="#000" opacity={0.5}>
      <Path d="M17.2 14h-4.45V5H15c.93 0 1.394 0 1.78.077a4 4 0 0 1 3.143 3.143c.043.214.062.452.07.78H20v1a2 2 0 0 0-2 2v1.2a.8.8 0 0 1-.8.8M11.25 14H6.8a.8.8 0 0 1-.8-.8V12a2 2 0 0 0-1.993-2V9c.008-.328.027-.566.07-.78A4 4 0 0 1 7.22 5.077C7.606 5 8.07 5 9 5h2.25z" />
    </G>
  </Svg>
);
