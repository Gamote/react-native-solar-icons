...
const SvgBath = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M6.797 3.886a4.1 4.1 0 0 0-1.38 1.774 4.18 4.18 0 0 0-.02 3.106.75.75 0 0 0 .995.414l5.96-2.566a.75.75 0 0 0 .402-.964 3.97 3.97 0 0 0-2.133-2.212 3.84 3.84 0 0 0-2.465-.192z"
    />
  </Svg>
);
