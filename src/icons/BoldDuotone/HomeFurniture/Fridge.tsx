...
const SvgFridge = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M4 10c0-3.771 0-5.657 1.172-6.828S8.229 2 12 2s5.657 0 6.828 1.172S20 6.229 20 10v1.5H4z"
      opacity={0.5}
    />
    <Path fill="#000" d="M17.75 7a.75.75 0 0 0-1.5 0v2a.75.75 0 0 0 1.5 0z" />
  </Svg>
);
