...
const SvgPlaylistMinimalistic2 = (props: SvgProps) => (
  ...
  >
    <G fill="#000" fillRule="evenodd" clipRule="evenodd" opacity={0.5}>
      <Path d="M15.75 6a.75.75 0 0 1-.75.75H3a.75.75 0 0 1 0-1.5h12a.75.75 0 0 1 .75.75M13.75 10a.75.75 0 0 1-.75.75H3a.75.75 0 0 1 0-1.5h10a.75.75 0 0 1 .75.75M9.75 14a.75.75 0 0 1-.75.75H3a.75.75 0 0 1 0-1.5h6a.75.75 0 0 1 .75.75M8.75 18a.75.75 0 0 1-.75.75H3a.75.75 0 0 1 0-1.5h5a.75.75 0 0 1 .75.75" />
    </G>
    <Path
      fill="#000"
