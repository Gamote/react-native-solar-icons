...
const SvgPhone = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M12.063 11.497c-2.946-2.929-1.88-4.008-1.873-4.014l-4.039 4.039c.667 1.004 1.535 2.082 2.664 3.205 1.14 1.133 2.26 1.974 3.322 2.595L16.1 13.36s-1.082 1.077-4.037-1.862"
      opacity={0.6}
    />
  </Svg>
);
