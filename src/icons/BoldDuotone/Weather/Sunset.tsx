...
const SvgSunset = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M4.25 19a.75.75 0 0 1 .75-.75h14a.75.75 0 0 1 0 1.5H5a.75.75 0 0 1-.75-.75M5.25 12c0 1.178.302 2.286.833 3.25h11.834A6.751 6.751 0 0 0 12.75 5.29h-1.5a6.75 6.75 0 0 0-6 6.709"
      opacity={0.5}
    />
    <Path
      fill="#000"
