...
const SvgRocket = (props: SvgProps) => (
  ...
  >
    ...
    <G fill="#000" opacity={0.5}>
      <Path d="M9.034 5.963 6.491 8.5c-.467.466-.896.893-1.235 1.28a6 6 0 0 0-.619.82l-.024-.025-.095-.094a4.9 4.9 0 0 0-1.532-1.004l-.123-.05-.379-.15a.764.764 0 0 1-.259-1.252C3.345 6.907 4.69 5.566 5.34 5.297a3.4 3.4 0 0 1 1.788-.229c.546.081 1.063.362 1.907.895M13.377 19.313c.205.208.34.355.464.512q.243.311.434.658c.142.26.253.537.474 1.092a.69.69 0 0 0 1.126.224l.084-.083c1.12-1.117 2.465-2.458 2.735-3.105a3.35 3.35 0 0 0 .229-1.782c-.081-.545-.362-1.06-.897-1.902l-2.552 2.544c-.478.477-.916.914-1.313 1.256-.237.206-.497.41-.784.586" />
    </G>
  </Svg>
);
