...
const SvgCamera = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M17.556 9.272a.826.826 0 0 0-.834.819c0 .452.373.818.834.818h1.11c.461 0 .834-.367.834-.818a.826.826 0 0 0-.833-.819z"
    />
    <Path
      fill="#000"
      fillRule="evenodd"
      d="M12 9.272c-2.301 0-4.166 1.832-4.166 4.091S9.699 17.454 12 17.454s4.167-1.831 4.167-4.09S14.3 9.271 12 9.271m0 1.637c-1.38 0-2.5 1.099-2.5 2.454s1.12 2.455 2.5 2.455 2.5-1.099 2.5-2.455c0-1.355-1.12-2.454-2.5-2.454"
      clipRule="evenodd"
    />
  </Svg>
);
