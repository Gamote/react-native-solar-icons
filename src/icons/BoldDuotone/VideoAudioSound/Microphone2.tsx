...
const SvgMicrophone2 = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M12.75 10.75c0 .414.336.75.75.75h4.2010000000000005l.049-1.5H13.5a.75.75 0 0 0-.75.75M12.75 7.75c0 .414.336.75.75.75h4.25L17.701 7H13.5a.75.75 0 0 0-.75.75M9.75 7.75A.75.75 0 0 0 9 7H6.298L6.25 8.5H9a.75.75 0 0 0 .75-.75M9.75 10.75A.75.75 0 0 0 9 10H6.25l.048 1.5H9a.75.75 0 0 0 .75-.75"
    />
  </Svg>
);
