...
const SvgCameraRotate = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M14.52 8.85a.75.75 0 0 1 .75.75v1.68a.75.75 0 0 1-.596.734l-1.52.32a.75.75 0 0 1-.471-1.414 2.417 2.417 0 1 0 1.719 2.595.75.75 0 0 1 1.49.17 3.918 3.918 0 1 1-2.123-3.941V9.6a.75.75 0 0 1 .75-.75"
    />
  </Svg>
);
