...
const SvgFolderCloud = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M16 13.882C16 15.052 14.977 16 13.714 16h-4C8.768 16 8 15.289 8 14.412s.768-1.589 1.714-1.589q.171 0 .332.03a2 2 0 0 1-.141-.735c0-1.17 1.023-2.118 2.286-2.118 1.175 0 2.144.823 2.271 1.88.895.288 1.538 1.075 1.538 2.002"
    />
  </Svg>
);
