...
const SvgSquareForward = (props: SvgProps) => (
  ...
  >
    <Path
      fill="#000"
      d="M1 13.53c0-4.667 0-7 1.45-8.45s3.783-1.45 8.45-1.45 7 0 8.45 1.45 1.45 3.783 1.45 8.45 0 7-1.45 8.45-3.783 1.45-8.45 1.45-7 0-8.45-1.45S1 18.197 1 13.53"
      opacity={0.5}
    />
    <Path
      fill="#000"
