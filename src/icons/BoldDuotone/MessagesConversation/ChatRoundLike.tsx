...
const SvgChatRoundLike = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M7.5 11.108c0 1.369 1.319 2.804 2.529 3.834.823.7 1.235 1.051 1.971 1.051s1.148-.35 1.971-1.051c1.21-1.03 2.529-2.465 2.529-3.834 0-2.677-2.475-3.676-4.5-1.608-2.025-2.068-4.5-1.069-4.5 1.608"
    />
  </Svg>
);
