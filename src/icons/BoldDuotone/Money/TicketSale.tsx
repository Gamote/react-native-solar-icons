...
const SvgTicketSale = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M15.548 8.47a.75.75 0 0 1 0 1.06l-6.015 6a.753.753 0 0 1-1.064 0 .75.75 0 0 1 0-1.06l6.015-6a.753.753 0 0 1 1.063 0M14.515 15.5a1.001 1.001 0 1 0 0-2 1.001 1.001 0 1 0 0 2M9.502 10.5a1.001 1.001 0 1 0 0-2 1.001 1.001 0 1 0 0 2"
    />
  </Svg>
);
