...
const SvgTag = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M10.124 7.271a2.017 2.017 0 1 1-2.853 2.852 2.017 2.017 0 0 1 2.853-2.852M19.051 12.051l-6.979 6.98a.75.75 0 1 1-1.06-1.06l6.979-6.98a.75.75 0 1 1 1.06 1.06"
    />
  </Svg>
);
