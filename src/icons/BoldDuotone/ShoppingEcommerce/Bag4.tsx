...
const SvgBag4 = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    <Path
      opacity={0.5}
      d="M4.03532 11.5733C4.4971 9.2644 4.72799 8.10995 5.55742 7.42997C6.38686 6.75 7.56417 6.75 9.9188 6.75H14.0812C16.4358 6.75 17.6131 6.75 18.4425 7.42997C19.272 8.10995 19.5029 9.2644 19.9646 11.5733L20.5646 14.5733C21.2287 17.8937 21.5608 19.5539 20.6606 20.652C19.7604 21.75 18.0673 21.75 14.6812 21.75H9.3188C5.93263 21.75 4.23954 21.75 3.33936 20.652C2.43919 19.5539 2.77123 17.8937 3.43532 14.5733L4.03532 11.5733Z"
