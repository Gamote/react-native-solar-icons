...
const SvgBagSmile = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M9.75 5.985a2.25 2.25 0 0 1 4.5 0v1c.566 0 1.062.002 1.5.015V5.985a3.75 3.75 0 1 0-7.5 0V7c.438-.013.934-.015 1.5-.015zM9.878 15.75a2.251 2.251 0 0 0 4.245 0 .75.75 0 1 1 1.414.5 3.751 3.751 0 0 1-7.073 0 .75.75 0 1 1 1.414-.5"
    />
  </Svg>
);
