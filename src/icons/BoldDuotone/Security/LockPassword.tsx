...
const SvgLockPassword = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M8 17a1 1 0 1 0 0-2 1 1 0 0 0 0 2M12 17a1 1 0 1 0 0-2 1 1 0 0 0 0 2M17 16a1 1 0 1 1-2 0 1 1 0 0 1 2 0M6.75 8a5.25 5.25 0 0 1 10.5 0v2.004c.567.005 1.064.018 1.5.05V8a6.75 6.75 0 0 0-13.5 0v2.055a24 24 0 0 1 1.5-.051z"
    />
  </Svg>
);
