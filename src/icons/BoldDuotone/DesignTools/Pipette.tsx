...
const SvgPipette = (props: SvgProps) => (
  ...
  >
    <Path
      fill="#000"
      d="m10.241 5.753 1.092 1.092 5.822 5.822 1.092 1.092a1.544 1.544 0 0 0 2.183-2.184l-1.091-1.091 1.455-1.456a4.117 4.117 0 1 0-5.822-5.822L13.516 4.66 12.425 3.57a1.544 1.544 0 1 0-2.184 2.183"
    />
    <Path
      fill="#000"
    ...
    <Path
      fill="#000"
      d="m12.116 14 1.854 1.852 1.06-1.06-1.853-1.854A.75.75 0 1 0 12.117 14M10.116 16l1.854 1.852 1.06-1.06-1.853-1.854A.75.75 0 1 0 10.117 16"
    />
  </Svg>
);
