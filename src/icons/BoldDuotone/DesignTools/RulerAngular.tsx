...
const SvgRulerAngular = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M4 17.25H2v1.5h2a.75.75 0 0 0 0-1.5M5 14.25H2v1.5h3a.75.75 0 0 0 0-1.5M4 11.25H2v1.5h2a.75.75 0 0 0 0-1.5M5 8.25H2v1.5h3a.75.75 0 0 0 0-1.5M9.75 5V2h-1.5v3a.75.75 0 0 0 1.5 0M12.75 4V2h-1.5v2a.75.75 0 0 0 1.5 0M15.75 5V2h-1.5v3a.75.75 0 0 0 1.5 0M18.75 4V2h-1.5v2a.75.75 0 0 0 1.5 0"
    />
  </Svg>
);
