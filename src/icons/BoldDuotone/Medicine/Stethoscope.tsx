...
const SvgStethoscope = (props: SvgProps) => (
  <Svg
    ...
    {...props}
  >
    <Circle cx={19} cy={16} r={3} fill="#000" />
    <Path
      fill="#000"
    ...
    <Path
      fill="#000"
      d="M8.25 14.95V17A5.75 5.75 0 0 0 14 22.75h.882a4.87 4.87 0 0 0 4.23-2.458c.247-.433.37-.896.43-1.34a3 3 0 0 1-1.5-.108 2.1 2.1 0 0 1-.232.705 3.37 3.37 0 0 1-2.928 1.701H14A4.25 4.25 0 0 1 9.75 17v-2.052a7.6 7.6 0 0 1-1.5.002"
      opacity={0.5}
    />
  </Svg>
);
