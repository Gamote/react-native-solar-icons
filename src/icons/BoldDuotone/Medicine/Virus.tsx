...
const SvgVirus = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      ...
      opacity={0.5}
    />
    <Circle cx={19.5} cy={4.5} r={1.5} fill="#000" />
    <Path
      fill="#000"
      ...
      opacity={0.5}
    />
    <Circle r={1.5} fill="#000" transform="matrix(1 0 0 -1 18.55 19.55)" />
    <Path
      fill="#000"
    ...
    <Path
      fill="#000"
      d="M17.1 19.161 15.85 17.91a7 7 0 0 0 1.17-.95l1.142 1.142a1.5 1.5 0 0 0-1.06 1.06"
    />
    <Circle r={2} fill="#000" transform="matrix(-1 0 0 1 4 4)" />
    <Path
      fill="#000"
      d="M4.781 5.842a2 2 0 0 0 1.06-1.06l1.69 1.688.037.04q-.587.471-1.058 1.058l-.04-.038z"
      opacity={0.5}
    />
    <Circle cx={5} cy={20} r={2} fill="#000" transform="rotate(-180 5 20)" />
    <Path
      fill="#000"
