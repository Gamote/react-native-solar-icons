...
const SvgDropperMinimalistic2 = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M18.998 7.25H17a.75.75 0 0 0 0 1.5h2V8q0-.403-.002-.75M19 10.25h-2a.75.75 0 0 0 0 1.5h2zM19 13.25h-2a.75.75 0 0 0 0 1.5h2zM14 4a2 2 0 1 0-4 0zM11.25 20.236q.75.06 1.5 0v1.014a.75.75 0 0 1-1.5 0z"
    />
    <Path
      fill="#000"
      fillRule="evenodd"
