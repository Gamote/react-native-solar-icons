...
const SvgDna = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M20.085 10.136 16.809 6.86a.75.75 0 0 0-1.061 1.061l3.008 3.008q.684-.34 1.329-.793M13.109 5.17l.948.947a.75.75 0 1 0 1.06-1.06L13.911 3.85q-.457.639-.802 1.32M10.897 18.724 9.835 17.66a.75.75 0 1 0-1.06 1.06l1.353 1.354c.298-.435.555-.888.77-1.351M3.857 13.918l3.113 3.113a.75.75 0 0 0 1.06-1.061L5.2 13.139a9.4 9.4 0 0 0-1.343.78M6.5 12.64l4.813 4.812q.023.023.048.044a8.2 8.2 0 0 0 .322-1.795l-3.384-3.384a8.2 8.2 0 0 0-1.798.323M17.549 11.431a1 1 0 0 0-.096-.118l-4.879-4.878a9 9 0 0 0-.406 1.714l3.683 3.684a9 9 0 0 0 1.698-.402"
      opacity={0.5}
    />
  </Svg>
);
