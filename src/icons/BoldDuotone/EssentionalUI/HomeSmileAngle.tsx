...
const SvgHomeSmileAngle = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M9.447 15.397a.75.75 0 0 0-.894 1.205A5.77 5.77 0 0 0 12 17.75a5.77 5.77 0 0 0 3.447-1.148.75.75 0 0 0-.894-1.205A4.27 4.27 0 0 1 12 16.25a4.27 4.27 0 0 1-2.553-.853"
    />
  </Svg>
);
