...
const SvgTrashBinMinimalistic2 = (props: SvgProps) => (
  ...
  >
    <Path
      fill="#000"
      d="M11.607 22h.787c2.707 0 4.06 0 4.94-.863s.971-2.28 1.151-5.111l.26-4.08c.097-1.537.146-2.306-.295-2.792-.442-.487-1.187-.487-2.679-.487H8.23c-1.492 0-2.237 0-2.679.487-.441.486-.392 1.255-.295 2.791l.26 4.08c.18 2.833.27 4.249 1.15 5.112S8.9 22 11.607 22"
      opacity={0.5}
    />
    <Path
      fill="#000"
