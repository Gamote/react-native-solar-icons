...
const SvgRugby = (props: SvgProps) => (
  ...
  >
    <Path
      fill="#000"
      d="M13.457 2.11c-2.883.277-5.947 1.142-8.076 3.27-2.13 2.13-2.994 5.194-3.271 8.077l8.433 8.433c2.883-.277 5.948-1.142 8.076-3.27 2.13-2.13 2.994-5.194 3.271-8.077z"
      opacity={0.5}
    />
    <Path
      fill="#000"
      d="M18.069 2.087a27 27 0 0 0-4.612.023l8.433 8.433c.16-1.67.125-3.28.023-4.612a4.136 4.136 0 0 0-3.844-3.844M5.931 21.913a27 27 0 0 0 4.612-.023L2.11 13.457c-.16 1.67-.125 3.28-.023 4.612a4.136 4.136 0 0 0 3.844 3.844"
    />
    <Path
      fill="#000"
      fillRule="evenodd"
