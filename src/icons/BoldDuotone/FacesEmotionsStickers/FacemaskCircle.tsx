...
const SvgFacemaskCircle = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M10 10.5c0 .828-.448 1.5-1 1.5s-1-.672-1-1.5S8.448 9 9 9s1 .672 1 1.5M16 10.5c0 .828-.448 1.5-1 1.5s-1-.672-1-1.5.448-1.5 1-1.5 1 .672 1 1.5M15.766 21.267l.444-5.776-2.632-1.052a4.25 4.25 0 0 0-3.156 0L7.79 15.49l.444 5.776A10 10 0 0 0 12 22c1.332 0 2.603-.26 3.766-.733M21.824 13.878l-4.112 1.644-.38 4.94a10 10 0 0 0 4.492-6.584M6.668 20.461 6.29 15.54l-4.077-1.482a10 10 0 0 0 4.456 6.404"
    />
  </Svg>
);
