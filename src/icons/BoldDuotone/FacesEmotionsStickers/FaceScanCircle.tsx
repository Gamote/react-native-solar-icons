...
const SvgFaceScanCircle = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M8.94 14.539a.71.71 0 0 1 .995-.148c.59.437 1.3.69 2.065.69a3.45 3.45 0 0 0 2.065-.69.71.71 0 1 1 .847 1.142 4.87 4.87 0 0 1-2.912.97 4.87 4.87 0 0 1-2.911-.97.71.71 0 0 1-.148-.994M14.488 11.644c.458 0 .83-.557.83-1.244s-.372-1.244-.83-1.244-.83.557-.83 1.244.372 1.244.83 1.244M9.512 11.644c.458 0 .83-.557.83-1.244s-.372-1.244-.83-1.244-.83.557-.83 1.244.372 1.244.83 1.244"
    />
  </Svg>
);
