...
const SvgStickerSmileCircle2 = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M10 10.5c0 .828-.448 1.5-1 1.5s-1-.672-1-1.5S8.448 9 9 9s1 .672 1 1.5M15 12c.552 0 1-.672 1-1.5S15.552 9 15 9s-1 .672-1 1.5.448 1.5 1 1.5M8.397 15.553a.75.75 0 0 1 1.05-.155 4.27 4.27 0 0 0 3.133.812q-.102.235-.187.478a5.6 5.6 0 0 0-.25 1.06L12 17.75a5.77 5.77 0 0 1-3.447-1.148.75.75 0 0 1-.156-1.049"
    />
  </Svg>
);
