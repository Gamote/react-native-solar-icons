...
const SvgBookBookmarkMinimalistic = (props: SvgProps) => (
  <Svg
  ...
  >
    ...
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="M7 16V9m0-6.5V5M13 16v3.53c0 .276 0 .414-.095.47s-.224-.006-.484-.13l-1.242-.59c-.088-.04-.132-.062-.179-.062s-.091.021-.179.063l-1.242.59c-.26.123-.39.185-.484.129C9 19.944 9 19.806 9 19.53v-3.08"
    />
  </Svg>
);
export default SvgBookBookmarkMinimalistic;
