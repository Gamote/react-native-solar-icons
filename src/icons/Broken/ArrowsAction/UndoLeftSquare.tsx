...
const SvgUndoLeftSquare = (props: SvgProps) => (
  ...
  >
    <Path
      ...
      strokeWidth={1.5}
      d="M6.5 9.5h7.539c1.367 0 2.051 0 2.547.32a2 2 0 0 1 .594.594c.32.495.32 1.18.32 2.547s0 2.052-.32 2.548a2 2 0 0 1-.594.593c-.496.32-1.18.32-2.547.32H9.5M6.5 9.5l2.25-2.077M6.5 9.5l2.25 2.077"
    />
    <Path
      stroke="#000"
      strokeLinecap="round"
