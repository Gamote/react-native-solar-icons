...
const SvgBombEmoji = (props: SvgProps) => (
  <Svg
    ...
    {...props}
  >
    <Path stroke="#000" strokeLinecap="round" strokeWidth={1.5} d="M10 16h2" />
    <Path
      fill="#000"
      d="M14 12.5c0 .828-.448 1.5-1 1.5s-1-.672-1-1.5.448-1.5 1-1.5 1 .672 1 1.5"
    />
    <Ellipse cx={9} cy={12.5} fill="#000" rx={1} ry={1.5} />
    <Path stroke="#000" strokeLinecap="round" strokeWidth={1.5} d="m17 7-2 2" />
    <Path
      stroke="#000"
      strokeWidth={1.5}
    ...
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="M5.75 8.003a7.5 7.5 0 1 1-2.747 2.747"
    />
  </Svg>
);
