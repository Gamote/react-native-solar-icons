...
const SvgMonitorCamera = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    ...
    <Path
      ...
      strokeWidth={1.5}
    />
    <Path d="M16 22H8" stroke="black" strokeWidth={1.5} strokeLinecap="round" />
    <Path
      d="M12 17L12 22"
      stroke="black"
      strokeWidth={1.5}
    ...
    />
    <Path
      d="M22 10V11C22 13.8284 22 15.2426 21.1213 16.1213C20.2426 17 18.8284 17 16 17H8C5.17157 17 3.75736 17 2.87868 16.1213C2 15.2426 2 13.8284 2 11V10M9.5 2C6.21252 2 4.56878 2 3.46243 2.90796C3.25989 3.07418 3.07418 3.25989 2.90796 3.46243C2.40259 4.07821 2.17851 4.86048 2.07915 6"
      stroke="black"
      strokeWidth={1.5}
      strokeLinecap="round"
    />
