...
const SvgHeadphonesSquareSound = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    ...
    />
    <Path
      d="M22 17V12C22 7.28595 22 4.92893 20.5355 3.46447C19.0711 2 16.714 2 12 2C10.4204 2 9.10541 2 8 2.0551M2 17V12C2 7.28595 2 4.92893 3.46447 3.46447C3.63075 3.29818 3.80855 3.15077 4 3.0201"
      stroke={props.primaryColor}
      strokeWidth={1.5}
      strokeLinecap="round"
    />
