...
const SvgRouting2 = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M12 4.25a.75.75 0 0 0 0 1.5zM12 19l.53.53a.75.75 0 0 0 0-1.06zm5.206-10.313.402.633zM6.794 15.313l.403.632zm4.236 1.657a.75.75 0 0 0-1.06 1.06zm-1.06 3a.75.75 0 1 0 1.06 1.06zm.861-6.337a.75.75 0 1 0-.805-1.266zm2.338-3.266a.75.75 0 1 0 .805 1.266zm2.963-6.117H12v1.5h4.132zM12 18.25H7.868v1.5H12zm.53.22-1.5-1.5-1.06 1.06 1.5 1.5zm-1.06 0-1.5 1.5 1.06 1.06 1.5-1.5zm-3.602-.22c-1.25 0-1.726-1.633-.671-2.305l-.805-1.265c-2.321 1.477-1.275 5.07 1.476 5.07zm8.264-12.5c1.25 0 1.726 1.633.671 2.305l.805 1.265c2.321-1.477 1.275-5.07-1.476-5.07zm-6.106 6.617L6.392 14.68l.805 1.265 3.634-2.312zm6.777-4.312-3.634 2.312.805 1.266 3.634-2.313z"
    />
    <Path
      stroke="#000"
      strokeLinecap="round"
