...
const SvgFloorLamp = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    ...
    />
    <Path
      d="M12 18V16.9368C12 15.6554 12.5899 14.4467 13.5965 13.6655L17.4782 10.8909M21.2207 10.6844L18.6886 7.44298M21.2207 10.6844C21.5703 11.132 21.4946 11.8018 20.9611 11.9887C19.7602 12.4094 18.3763 12.0438 17.5452 10.9798C17.5222 10.9505 17.4999 10.9208 17.4782 10.8909M21.2207 10.6844C22.1078 9.97894 22.2602 8.6814 21.561 7.7863C20.8617 6.8912 19.5757 6.73749 18.6886 7.44298M18.6886 7.44298C18.339 6.99543 17.6758 6.9132 17.371 7.39296C16.704 8.44296 16.713 9.83644 17.4782 10.8909"
      stroke={props.primaryColor}
      strokeWidth={1.5}
      strokeLinecap="round"
    />
