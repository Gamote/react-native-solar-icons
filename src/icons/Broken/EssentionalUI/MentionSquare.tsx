...
const SvgMentionSquare = (props: SvgProps) => (
  <Svg
  ...
  >
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="M12 18a6 6 0 1 1 5.64-3.946 1.54 1.54 0 0 1-.413.599l-.08.074a1.636 1.636 0 0 1-2.747-1.203V12m0 0a2.4 2.4 0 1 1-4.8 0 2.4 2.4 0 0 1 4.8 0Z"
    />
    <Path
      stroke="#000"
      strokeLinecap="round"
