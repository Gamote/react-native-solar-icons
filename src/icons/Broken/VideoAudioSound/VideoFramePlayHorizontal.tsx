...
const SvgVideoFramePlayHorizontal = (props: SvgProps) => (
  ...
  >
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="M21.5 17h-19M21.5 7h-19M12 2v5m0 15v-5M17 2.5V7m0 14.5V17M7 2.5V7m0 14.5V17M14 12c0-.528-.53-.884-1.589-1.596-1.073-.721-1.61-1.082-2.01-.817C10 9.852 10 10.567 10 12s0 2.148.4 2.413.938-.096 2.011-.817C13.471 12.884 14 12.528 14 12Z"
    />
    <Path
      stroke="#000"
      strokeLinecap="round"
