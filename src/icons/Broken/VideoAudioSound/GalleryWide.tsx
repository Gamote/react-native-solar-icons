...
const SvgGalleryWide = (props: SvgProps) => (
  ...
  >
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="M22 13.438c0 3.77 0 5.656-1.172 6.828S17.771 21.438 14 21.438h-4c-3.771 0-5.657 0-6.828-1.172S2 17.209 2 13.438 2 7.78 3.172 6.609 6.229 5.438 10 5.438h4c3.771 0 5.657 0 6.828 1.171.664.664.952 1.556 1.076 2.891"
    />
    <Path
      stroke="#000"
      strokeWidth={1.5}
    ...
    />
    <Circle cx={17.5} cy={9.938} r={1.5} stroke="#000" strokeWidth={1.5} />
    <Path
      stroke="#000"
      strokeLinecap="round"
      strokeWidth={1.5}
