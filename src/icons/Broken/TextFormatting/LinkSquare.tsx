...
const SvgLinkSquare = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M10 12c0 2.828 0 4.243.879 5.121C11.757 18 13.172 18 16 18s4.243 0 5.121-.879c.3-.3.498-.662.628-1.121M22 12c0-2.828 0-4.243-.879-5.121C20.243 6 18.828 6 16 6"
    />
  </Svg>
);
