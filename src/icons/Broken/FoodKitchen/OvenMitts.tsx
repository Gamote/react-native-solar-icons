...
const SvgOvenMitts = (props: SvgProps) => (
  ...
  >
    <Path
      fill="#000"
      d="M9.133 17.025a.75.75 0 1 0 1.05-1.07zm3.364 1.192a.75.75 0 1 0-1.039 1.082zm-2.314-2.262-5.639-5.536-1.05 1.07 5.639 5.536zm3.634 3.53-1.32-1.268-1.039 1.082 1.32 1.268z"
    />
    <Path
      stroke="#000"
      strokeLinecap="round"
