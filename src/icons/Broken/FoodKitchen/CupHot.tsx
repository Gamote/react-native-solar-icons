...
const SvgCupHot = (props: SvgProps) => (
  ...
  >
    ...
    />
    <Path stroke="#000" strokeWidth={1.5} d="M17 17h1a4 4 0 0 0 0-8h-1" />
    <Path
      fill="#000"
      d="M10 18.75a.75.75 0 0 0 0-1.5zm3.5-1.5a.75.75 0 0 0 0 1.5zm-3.5 0H4v1.5h6zm6 0h-2.5v1.5H16z"
    />
    <Path
      stroke="#000"
      strokeLinecap="round"
