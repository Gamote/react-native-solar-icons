...
const SvgInboxOut = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="M22 12c0 4.714 0 7.071-1.465 8.536C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.464C2 19.07 2 16.714 2 12S2 4.93 3.464 3.465C4.281 2.648 5.374 2.287 7 2.127m10 0c1.625.16 2.72.521 3.535 1.338.974.973 1.3 2.342 1.41 4.535"
    />
  </Svg>
);
