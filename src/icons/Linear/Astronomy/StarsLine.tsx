...
const SvgStarsLine = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="M11 22c-.334-2.167-.8-7.2 0-10M14.5 22c0-3.333 1.5-9 7.5-12.5"
    />
    <Path
      stroke="#000"
      strokeLinejoin="round"
      d="M5 13.268s.65.748 1.223.901S7.733 14 7.733 14s-.749.65-.902 1.223.169 1.51.169 1.51-.65-.749-1.223-.902-1.51.17-1.51.17.749-.65.902-1.224C5.323 14.206 5 13.269 5 13.269Z"
    />
  </Svg>
);
