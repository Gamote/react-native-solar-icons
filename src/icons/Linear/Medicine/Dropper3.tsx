...
const SvgDropper3 = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    ...
    />
    <Path
      d="M18 11.4167C18 12.5673 17.1046 13.5 16 13.5C14.8954 13.5 14 12.5673 14 11.4167C14 10.6968 14.783 9.73595 15.3691 9.11749C15.7161 8.75136 16.2839 8.75136 16.6309 9.11749C17.217 9.73595 18 10.6968 18 11.4167Z"
      stroke={props.primaryColor}
      strokeWidth={1.5}
    />
    <Path
