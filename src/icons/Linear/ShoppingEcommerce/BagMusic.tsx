...
const SvgBagMusic = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="m14.058 9.971-1.316.658a2.3 2.3 0 0 0-.35.195 1 1 0 0 0-.374.606c-.018.093-.018.195-.018.4 0 .485 0 .728.06.893a1 1 0 0 0 1.056.652c.174-.02.391-.129.826-.346l1.316-.658c.183-.091.274-.137.35-.194a1 1 0 0 0 .374-.607c.018-.093.018-.195.018-.399 0-.486 0-.728-.06-.893a1 1 0 0 0-1.056-.653c-.174.02-.391.129-.826.346Z"
    />
  </Svg>
);
