...
const SvgBag5 = (props: SvgProps) => (
  ...
  >
    <Path
      stroke="#000"
      strokeWidth={1.5}
      d="M3.794 14.97c.537 2.687.806 4.03 1.693 4.895q.247.24.53.434C7.04 21 8.41 21 11.15 21h1.703c2.739 0 4.108 0 5.13-.7q.285-.196.53-.435c.888-.865 1.157-2.208 1.694-4.894.771-3.856 1.157-5.784.269-7.15a4 4 0 0 0-.56-.683C18.75 6 16.785 6 12.853 6h-1.703C7.216 6 5.25 6 4.084 7.138a4 4 0 0 0-.559.683c-.888 1.366-.502 3.294.27 7.15Z"
    />
