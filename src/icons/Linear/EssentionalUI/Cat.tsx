...
const SvgCat = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    ...
    />
    <Path
      d="M12.826 15.9999C12.826 16.1725 12.4649 16.3124 12.0195 16.3124C11.5741 16.3124 11.2131 16.1725 11.2131 15.9999C11.2131 15.8273 11.5741 15.6874 12.0195 15.6874C12.4649 15.6874 12.826 15.8273 12.826 15.9999Z"
      stroke={props.primaryColor}
      strokeWidth={1.5}
    />
    <Path
      d="M15.5 13.5938C15.5 14.0252 15.2834 14.375 15.0162 14.375C14.7489 14.375 14.5323 14.0252 14.5323 13.5938C14.5323 13.1623 14.7489 12.8125 15.0162 12.8125C15.2834 12.8125 15.5 13.1623 15.5 13.5938Z"
      stroke={props.primaryColor}
      strokeWidth={1.5}
    />
    <Path
      d="M9.50012 13.5938C9.50012 14.0252 9.28349 14.375 9.01625 14.375C8.74901 14.375 8.53238 14.0252 8.53238 13.5938C8.53238 13.1623 8.74901 12.8125 9.01625 12.8125C9.28349 12.8125 9.50012 13.1623 9.50012 13.5938Z"
      stroke={props.primaryColor}
      strokeWidth={1.5}
    />
    <Path
