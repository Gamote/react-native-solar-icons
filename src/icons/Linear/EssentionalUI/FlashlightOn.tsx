...
const SvgFlashlightOn = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    <Path
      ...
      strokeLinecap="round"
    />
    <Path d="M15 16H9" stroke="black" strokeWidth={1.5} strokeLinecap="round" />
    <Path
      d="M4.5 11H19.5"
      stroke="black"
      strokeWidth={1.5}
      strokeLinecap="round"
    />
    <Path d="M12 5V2" stroke="black" strokeWidth={1.5} strokeLinecap="round" />
    <Path d="M8 5L6 3" stroke="black" strokeWidth={1.5} strokeLinecap="round" />
    <Path
      d="M16 5L18 3"
      stroke="black"
      strokeWidth={1.5}
