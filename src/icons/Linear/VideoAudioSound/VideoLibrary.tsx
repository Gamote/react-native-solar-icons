...
const SvgVideoLibrary = (props: SvgProps) => (
  ...
  >
    <Path
      stroke="#000"
      strokeWidth={1.5}
      d="M19.562 7a2.132 2.132 0 0 0-2.1-2.5H6.538a2.132 2.132 0 0 0-2.1 2.5M17.5 4.5c.028-.26.043-.389.043-.496a2 2 0 0 0-1.787-1.993C15.65 2 15.52 2 15.26 2H8.74c-.26 0-.39 0-.497.011a2 2 0 0 0-1.787 1.993c0 .107.015.237.043.496M14.581 13.616c.559.346.559 1.242 0 1.588l-3.371 2.09c-.543.337-1.21-.1-1.21-.794v-4.18c0-.693.667-1.13 1.21-.794z"
    />
    <Path
      stroke="#000"
      strokeWidth={1.5}
