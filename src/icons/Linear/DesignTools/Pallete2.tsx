...
const SvgPallete2 = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    ...
    <Path
      d="M11.085 7C11.085 7.82843 10.4134 8.5 9.58502 8.5C8.75659 8.5 8.08502 7.82843 8.08502 7C8.08502 6.17157 8.75659 5.5 9.58502 5.5C10.4134 5.5 11.085 6.17157 11.085 7Z"
      stroke="black"
      strokeWidth={1.5}
    />
    <Path
