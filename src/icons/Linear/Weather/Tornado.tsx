...
const SvgTornado = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    <Path
      d="M12 3C7.02944 3 3 3.67157 3 4.5C3 5.32843 7.02944 6 12 6C16.9706 6 21 5.32843 21 4.5C21 3.97993 19.412 3.52168 17 3.25259"
    ...
    />
    <Path
      d="M16 16.5C15.2525 16.7554 14.3516 17 13 17C11.6484 17 10.6575 16.8786 10 16.7554"
      stroke={props.primaryColor}
      strokeWidth={1.5}
      strokeLinecap="round"
    />
