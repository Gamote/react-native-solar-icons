...
const SvgCondicioner = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="m7 17.5-.307.46A1.32 1.32 0 0 0 7 19.75c.561.42.696 1.206.307 1.79L7 22m5-4.5-.307.46A1.32 1.32 0 0 0 12 19.75c.561.42.696 1.206.307 1.79L12 22m5-4.5-.307.46A1.32 1.32 0 0 0 17 19.75c.561.42.696 1.206.307 1.79L17 22M18 14.5c0-.465 0-.697-.038-.89a2 2 0 0 0-1.572-1.572C16.197 12 15.965 12 15.5 12H9c-.932 0-1.398 0-1.765.152a2 2 0 0 0-1.083 1.083c-.122.295-.146.653-.15 1.265M6 8.5h12M6 6h12"
    />
  </Svg>
);
