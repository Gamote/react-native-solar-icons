...
const SvgCondicioner = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    ...
    />
    <Path
      d="M6.99995 17.5L6.69333 17.9599C6.30432 18.5435 6.43892 19.3292 6.99995 19.75C7.56099 20.1708 7.69559 20.9565 7.30658 21.5401L6.99995 22M12 17.5L11.6933 17.9599C11.3043 18.5435 11.4389 19.3292 12 19.75C12.561 20.1708 12.6956 20.9565 12.3066 21.5401L12 22M17 17.5L16.6933 17.9599C16.3043 18.5435 16.4389 19.3292 17 19.75C17.561 20.1708 17.6956 20.9565 17.3066 21.5401L17 22"
      stroke={props.primaryColor}
      strokeWidth={1.5}
      strokeLinecap="round"
    />
