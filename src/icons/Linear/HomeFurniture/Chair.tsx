...
const SvgChair = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    ...
    />
    <Path
      d="M15.5 12H8.50001C6.8501 12 6.02514 12 5.51257 12.5858C5.22669 12.9125 5.10026 13.3503 5.04435 14.0008C4.9669 14.9018 4.92818 15.3523 5.22538 15.6762C5.52259 16 6.01506 16 7.00001 16H17C17.985 16 18.4774 16 18.7746 15.6762C19.0718 15.3523 19.0331 14.9018 18.9557 14.0008C18.8998 13.3503 18.7733 12.9125 18.4874 12.5858C17.9749 12 17.1499 12 15.5 12Z"
      stroke="black"
      strokeWidth={1.5}
    />
    <Path
