...
const SvgObjectScan = (props: SvgProps) => (
  ...
  >
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="M22 14c0 3.771 0 5.657-1.172 6.828S17.771 22 14 22M10 22c-3.771 0-5.657 0-6.828-1.172S2 17.771 2 14M10 2C6.229 2 4.343 2 3.172 3.172S2 6.229 2 10M14 2c3.771 0 5.657 0 6.828 1.172S22 6.229 22 10M4 11.5s2.4-2 8-2 8 2 8 2"
    />
    <Path
      fill="#000"
    ...
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="M6 14v.5c0 1.886 0 2.828.586 3.414S8.114 18.5 10 18.5h4c1.886 0 2.828 0 3.414-.586S18 16.386 18 14.5V14"
    />
  </Svg>
);
