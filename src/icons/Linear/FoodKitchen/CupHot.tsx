...
const SvgCupHot = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    ...
    <Path
      ...
      strokeWidth={1.5}
    />
    <Path d="M16 18H4" stroke={props.primaryColor} strokeWidth={1.5} />
    <Path
      d="M6.05068 5.0614L6.4613 4.48574C6.68808 4.16781 6.61419 3.72623 6.29626 3.49945C5.97832 3.27267 5.90443 2.8311 6.13121 2.51317L6.54183 1.9375M14.0507 5.0614L14.4613 4.48574C14.6881 4.16781 14.6142 3.72623 14.2963 3.49945C13.9783 3.27267 13.9044 2.8311 14.1312 2.51317L14.5418 1.9375M10.0507 5.0614L10.4613 4.48574C10.6881 4.16781 10.6142 3.72623 10.2963 3.49945C9.97832 3.27267 9.90443 2.8311 10.1312 2.51317L10.5418 1.9375"
      stroke={props.primaryColor}
      strokeWidth={1.5}
      strokeLinecap="round"
    />
