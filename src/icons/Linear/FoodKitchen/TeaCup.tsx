...
const SvgTeaCup = (props: SvgProps) => (
  ...
  >
    ...
    />
    <Path stroke="#000" strokeWidth={1.5} d="M17 17h2a3 3 0 1 0 0-6h-1.5" />
    <Path
      stroke="#000"
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M10 2a1.414 1.414 0 0 0 0 2 1.414 1.414 0 0 1 0 2M5 7.5l.116-.116c.507-.507.564-1.31.134-1.884a1.44 1.44 0 0 1 .134-1.884L5.5 3.5M14.5 7.5l.116-.116c.507-.507.564-1.31.134-1.884a1.44 1.44 0 0 1 .134-1.884L15 3.5"
    />
  </Svg>
);
