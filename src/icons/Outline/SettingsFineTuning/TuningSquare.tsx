...
const SvgTuningSquare = (props: SvgProps) => (
  ...
  >
    <Path
      fill="#000"
      fillRule="evenodd"
      d="M5.25 10a2.75 2.75 0 1 1 5.5 0 2.75 2.75 0 0 1-5.5 0M8 8.75a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5M16 16.75a2.75 2.75 0 1 1 0-5.5 2.75 2.75 0 0 1 0 5.5M14.75 14a1.25 1.25 0 1 0 2.5 0 1.25 1.25 0 0 0-2.5 0"
      clipRule="evenodd"
    />
    <Path
      fill="#000"
      d="M8 13.25a.75.75 0 0 1 .75.75v5a.75.75 0 0 1-1.5 0v-5a.75.75 0 0 1 .75-.75M16.75 10a.75.75 0 0 1-1.5 0V5a.75.75 0 0 1 1.5 0zM8 4.25a.75.75 0 0 1 .75.75v1a.75.75 0 0 1-1.5 0V5A.75.75 0 0 1 8 4.25M16.75 19a.75.75 0 0 1-1.5 0v-1a.75.75 0 0 1 1.5 0z"
    />
    <Path
      fill="#000"
      fillRule="evenodd"
