...
const SvgMaximizeSquare = (props: SvgProps) => (
  ...
  >
    <Path
      fill="#000"
      d="M12.5 7a.75.75 0 0 1 .75-.75H17a.75.75 0 0 1 .75.75v3.75a.75.75 0 0 1-1.5 0V8.81l-7.44 7.44h1.94a.75.75 0 0 1 0 1.5H7a.75.75 0 0 1-.75-.75v-3.75a.75.75 0 0 1 1.5 0v1.94l7.44-7.44h-1.94A.75.75 0 0 1 12.5 7"
    />
    <Path
      fill="#000"
      fillRule="evenodd"
