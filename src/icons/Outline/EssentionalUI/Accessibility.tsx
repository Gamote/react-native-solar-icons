...
const SvgAccessibility = (props: SvgProps) => (
  ...
  >
    <Path
      fill="#000"
      fillRule="evenodd"
      d="M9.25 7a2.75 2.75 0 1 1 5.5 0 2.75 2.75 0 0 1-5.5 0M12 5.75a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5"
      clipRule="evenodd"
    />
    <Path
      fill="#000"
      d="M5.31 9.707a.75.75 0 0 1 .983-.398l.001.001.006.003.027.011.11.045q.149.061.42.164c.36.137.865.32 1.445.502 1.178.37 2.587.715 3.698.715s2.52-.345 3.698-.715a27 27 0 0 0 1.974-.711l.028-.011.006-.003h.001a.75.75 0 0 1 .586 1.38l-.004.002-.01.004-.032.014-.123.05a28.085 28.085 0 0 1-1.976.706c-.988.31-2.236.639-3.398.747v1.24c0 .43.124.853.357 1.216l2.524 3.925a.75.75 0 0 1-1.262.812L12 15.72l-2.37 3.686a.75.75 0 1 1-1.26-.812l2.523-3.925a2.25 2.25 0 0 0 .357-1.217v-1.239c-1.162-.108-2.41-.436-3.399-.747a28 28 0 0 1-2.098-.756l-.033-.014-.009-.004-.004-.001a.75.75 0 0 1-.397-.984"
    />
    <Path
      fill="#000"
      fillRule="evenodd"
