...
const SvgStationMinimalistic = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#000"
      d="M8.55 9.055c0-1.93 1.55-3.483 3.45-3.483s3.45 1.554 3.45 3.483c0 .932-.362 1.777-.952 2.402a.75.75 0 1 0 1.09 1.03 4.99 4.99 0 0 0 1.362-3.432c0-2.747-2.21-4.983-4.95-4.983S7.05 6.308 7.05 9.055c0 1.348.533 2.573 1.398 3.47a.75.75 0 1 0 1.08-1.041 3.49 3.49 0 0 1-.978-2.43"
    />
    <Path
      fill="#000"
      fillRule="evenodd"
